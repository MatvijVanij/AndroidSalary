...
object Constans {
    const val  Driver_Salary = 10
    const val  Enginer_Salary = 100
    const val  Director_Salary = 1000
    ...
    const val  Driver_Password = "3"
    const val  PMHead_Password = "4"
    const val  SuperHead_Password = "5"
